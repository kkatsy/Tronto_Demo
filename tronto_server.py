...
def start_server(url_root='/api',
    ...
    @app.route("/qa_server", methods=['POST'])
    def qa_server():
        data = request.json
        # print(data)
    ...
    @app.route("/tweet_server", methods=['POST'])
    def tweet_server():
        data = request.json
    ...
    @app.route("/")
    def hello():
        return "Hello world! This is the entry of Tronto API server"
